    ...
    public class DualKeyDictionary<TValue>
    {
        ...
        public TValue this[int id]
        {
            get
            {
                ...
                {
                    throw new KeyNotFoundException($"The integer key '{id}' was not found in the dictionary.");
                }
                return value;
            }
            set
        ...
        public TValue this[string key]
        {
            get
            {
                ...
                {
                    throw new KeyNotFoundException($"The string key '{key}' was not found in the dictionary.");
                }
                return value;
            }
            set
